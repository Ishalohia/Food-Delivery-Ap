        ...
        <Row className={classes.row_content}>
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              <h4 className={classes.header_text}>Khushi Jha</h4>
              <p className={classes.text_location}>LPU</p>
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              <h4 className={classes.header_text}>Vivek Kumar</h4>
              <p className={classes.text_location}>LPU</p>
              <p className={classes.text_content}>
                {" "}
          ...
          >
            <div className={`${classes.text_div} px-2`}>
              <h4 className={classes.header_text}>Simran Kumari</h4>
              <p className={classes.text_location}>LPU</p>
              <p className={classes.text_content}>
